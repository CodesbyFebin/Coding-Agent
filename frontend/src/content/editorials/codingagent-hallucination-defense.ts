...
export const codingagentHallucinationDefense: PillarEditorial = {
  pillarId: 'codingagent-hallucination-defense',
  updated: '2026-09-16',
  definition: 'Automated self-correcting logic engine that detects model hallucinations, syntax drift, and fabricated APIs before code execution.',
  sections: [
    {
      heading: 'What CodingAgent Hallucination Defense Actually Does',
      paragraphs: [
  ...
  faq: [
    {
      question: 'What problem does CodingAgent Hallucination Defense actually solve?',
      answer: 'Automated self-correcting logic engine that detects model hallucinations, syntax drift, and fabricated APIs before code execution. Prevents destructive code mutations by verifying AST validity and symbol presence against real repository definitions.',
    },
    {
      question: 'How is completion or correctness verified for this pillar?',
      answer: 'Deterministic AST diff comparison and LSP symbol resolution pass/fail checks.',
    },
    {
    ...
    {
      question: 'How does this pillar relate to CodingAgent Independent Verification, CodingAgent Typecheck Verification?',
      answer: 'It composes directly with CodingAgent Independent Verification, CodingAgent Typecheck Verification, CodingAgent Plan-Execute-Verify, CodingAgent Unit Test Verification: none of these are meant to be adopted in isolation, and the platform\'s guarantees in this area assume the related pillars are also in place around it.',
    },
    {
    ...
    },
    {
      ...
      answer: 'It is categorized under India & Solutions, tagged hallucination-defense, ast, self-correction, safety.',
    },
    {
      question: 'Who should read this page before adopting CodingAgent Hallucination Defense?',
    ...
    {
      question: 'What\'s the recommended rollout sequence for CodingAgent Hallucination Defense?',
