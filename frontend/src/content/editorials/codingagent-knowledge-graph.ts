...
export const codingagentKnowledgeGraph: PillarEditorial = {
  ...
  updated: '2026-09-16',
  definition: 'The interconnected ontology of 80 sovereign engineering pillars designed for human engineers and AI search engines.',
  sections: [
    {
      heading: 'What CodingAgent Knowledge Graph Actually Does',
      paragraphs: [
        ...
        'Establishes authoritative domain concepts for agentic engineering without vague marketing buzzwords. That is the practical justification for treating this as its own architectural pillar rather than folding it into a more general capability: the failure modes it addresses are specific enough that a generic policy would either under-protect or over-restrict the surrounding workflow.',
      ],
      bullets: [
        'Tag: ontology',
        'Tag: knowledge-graph',
    ...
    },
    {
      ...
      paragraphs: [
        'Teams adopting \'CodingAgent Knowledge Graph\' should start by confirming the boundary described above actually matches their own risk tolerance -- the default configuration reflects a reasonable general-purpose posture, not necessarily the most restrictive (or most permissive) one available. Where the platform exposes configuration for this pillar, treat it the same way you would treat any other security- or correctness-relevant configuration: version it, review changes to it, and test that a change actually has the effect you expect before relying on it in a live workflow.',
    ...
    },
    {
      ...
      paragraphs: [
        'Rather than taking any architectural description at face value -- including this one -- the more useful exercise for a team evaluating CodingAgent.in is to write down the specific failure scenario \'CodingAgent Knowledge Graph\' claims to prevent, and then check whether the platform\'s actual verification mechanism (described above) would catch that exact scenario if it happened. If it would not, that\'s a real gap worth raising, not a reason to distrust the pillar model in general -- the whole premise of naming these things explicitly is so gaps are locatable and fixable rather than hidden inside a vague, unauditable system prompt.',
        'The href for this page (`/knowledge-graph`) is a stable, canonical identifier once the pillar crosses the platform\'s own indexability bar -- so it\'s reasonable to bookmark or cite directly when tracking an evaluation decision back to the specific architectural claim that informed it.',
      ],
    },
  ],
  faq: [
    {
      question: 'What problem does CodingAgent Knowledge Graph actually solve?',
      answer: 'The interconnected ontology of 80 sovereign engineering pillars designed for human engineers and AI search engines. Establishes authoritative domain concepts for agentic engineering without vague marketing buzzwords.',
    },
    {
      question: 'How is completion or correctness verified for this pillar?',
      answer: 'Structured schema.org graph metadata validated with JSON-LD standards.',
    },
    {
    ...
    },
    {
      ...
      answer: 'It is categorized under Platform Pillars, tagged ontology, knowledge-graph, 80-pillars.',
    },
    {
      question: 'Who should read this page before adopting CodingAgent Knowledge Graph?',
    ...
    {
      question: 'What\'s the recommended rollout sequence for CodingAgent Knowledge Graph?',
