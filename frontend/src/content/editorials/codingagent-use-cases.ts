...
export const codingagentUseCases: PillarEditorial = {
  pillarId: 'codingagent-use-cases',
  updated: '2026-09-16',
  definition: 'Real-world engineering scenarios: large-scale refactoring, legacy migration, CVE remediation, and automated documentation.',
  sections: [
    {
      heading: 'What CodingAgent Use Cases Actually Does',
      paragraphs: [
        'Real-world engineering scenarios: large-scale refactoring, legacy migration, CVE remediation, and automated documentation. Within CodingAgent.in\'s broader agentic engineering platform, this pillar is not a standalone feature toggle but a design constraint that shapes how the surrounding Platform Pillars components are allowed to behave. Every capability described here is scoped by the same governance model the rest of the platform uses: an explicit boundary between what a model may reason about and what a tool is actually permitted to execute.',
        'Demonstrates proven production patterns for deploying agents on high-value developer challenges. That is the practical justification for treating this as its own architectural pillar rather than folding it into a more general capability: the failure modes it addresses are specific enough that a generic policy would either under-protect or over-restrict the surrounding workflow.',
      ],
      bullets: [
        'Tag: use-cases',
        'Tag: scenarios',
    ...
    },
    {
      ...
      paragraphs: [
        'Teams adopting \'CodingAgent Use Cases\' should start by confirming the boundary described above actually matches their own risk tolerance -- the default configuration reflects a reasonable general-purpose posture, not necessarily the most restrictive (or most permissive) one available. Where the platform exposes configuration for this pillar, treat it the same way you would treat any other security- or correctness-relevant configuration: version it, review changes to it, and test that a change actually has the effect you expect before relying on it in a live workflow.',
    ...
    },
    {
      ...
      paragraphs: [
        'Rather than taking any architectural description at face value -- including this one -- the more useful exercise for a team evaluating CodingAgent.in is to write down the specific failure scenario \'CodingAgent Use Cases\' claims to prevent, and then check whether the platform\'s actual verification mechanism (described above) would catch that exact scenario if it happened. If it would not, that\'s a real gap worth raising, not a reason to distrust the pillar model in general -- the whole premise of naming these things explicitly is so gaps are locatable and fixable rather than hidden inside a vague, unauditable system prompt.',
        'The href for this page (`/use-cases`) is a stable, canonical identifier once the pillar crosses the platform\'s own indexability bar -- so it\'s reasonable to bookmark or cite directly when tracking an evaluation decision back to the specific architectural claim that informed it.',
      ],
    },
  ],
  faq: [
    {
      question: 'What problem does CodingAgent Use Cases actually solve?',
      answer: 'Real-world engineering scenarios: large-scale refactoring, legacy migration, CVE remediation, and automated documentation. Demonstrates proven production patterns for deploying agents on high-value developer challenges.',
    },
    {
      question: 'How is completion or correctness verified for this pillar?',
      answer: 'Case study evidence recording speedup factors and verification pass rates.',
    },
    {
    ...
    },
    {
      ...
      answer: 'It is categorized under Platform Pillars, tagged use-cases, scenarios, production.',
    },
    {
      question: 'Who should read this page before adopting CodingAgent Use Cases?',
    ...
    {
      question: 'What\'s the recommended rollout sequence for CodingAgent Use Cases?',
    ...
    },
    {
      ...
      answer: 'Just this one, deliberately. \'CodingAgent Use Cases\' does not silently absorb responsibility for adjacent concerns like general model routing, workspace lifecycle, or organization-wide policy -- those are each their own pillars with their own explicit boundary. If a capability you need sounds adjacent but isn\'t covered here, check the knowledge graph\'s category grouping for the more precise pillar.',
    },
    {
      question: 'What is the canonical URL for this pillar once it\'s fully documented?',
      answer: '`/use-cases` on codingagent.in -- once an editorial crosses the platform\'s own indexability bar (currently 2,000 words of substantive, non-duplicated content), that URL becomes the canonical, sitemap-listed identifier for this pillar, suitable for bookmarking or citing directly in an evaluation writeup.',
    },
    {
      question: 'How does CodingAgent Use Cases fail -- does it fail open or fail closed?',
