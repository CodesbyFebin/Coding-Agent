...
export const auditLogsProvenance: PillarEditorial = {
  ...
  updated: '2026-09-16',
  definition: 'Immutable, tamper-evident cryptographic logs recording every model prompt, tool call argument, output diff, and verification hash.',
  sections: [
    {
      heading: 'What CodingAgent Audit Logs & Provenance Actually Does',
      paragraphs: [
        'Immutable, tamper-evident cryptographic logs recording every model prompt, tool call argument, output diff, and verification hash. Within CodingAgent.in\'s broader agentic engineering platform, this pillar is not a standalone feature toggle but a design constraint that shapes how the surrounding Security & Sovereignty components are allowed to behave. Every capability described here is scoped by the same governance model the rest of the platform uses: an explicit boundary between what a model may reason about and what a tool is actually permitted to execute.',
        'Provides compliance and security teams complete forensic evidence of software authorship and supply-chain integrity. That is the practical justification for treating this as its own architectural pillar rather than folding it into a more general capability: the failure modes it addresses are specific enough that a generic policy would either under-protect or over-restrict the surrounding workflow.',
      ],
      bullets: [
        'Tag: provenance',
        'Tag: slsa',
    ...
    },
    {
      ...
      paragraphs: [
        'Rather than taking any architectural description at face value -- including this one -- the more useful exercise for a team evaluating CodingAgent.in is to write down the specific failure scenario \'CodingAgent Audit Logs & Provenance\' claims to prevent, and then check whether the platform\'s actual verification mechanism (described above) would catch that exact scenario if it happened. If it would not, that\'s a real gap worth raising, not a reason to distrust the pillar model in general -- the whole premise of naming these things explicitly is so gaps are locatable and fixable rather than hidden inside a vague, unauditable system prompt.',
        'The href for this page (`/audit-logs-provenance`) is a stable, canonical identifier once the pillar crosses the platform\'s own indexability bar -- so it\'s reasonable to bookmark or cite directly when tracking an evaluation decision back to the specific architectural claim that informed it.',
      ],
    },
  ],
  faq: [
    {
      question: 'What problem does CodingAgent Audit Logs & Provenance actually solve?',
      answer: 'Immutable, tamper-evident cryptographic logs recording every model prompt, tool call argument, output diff, and verification hash. Provides compliance and security teams complete forensic evidence of software authorship and supply-chain integrity.',
    },
    {
      question: 'How is completion or correctness verified for this pillar?',
      answer: 'Merkle tree hashing and signed SLSA provenance attestations for generated release artifacts.',
    },
    {
    ...
    },
    {
      ...
      answer: 'It is categorized under Security & Sovereignty, tagged provenance, slsa, tamper-evident.',
    },
    {
      question: 'Who should read this page before adopting CodingAgent Audit Logs & Provenance?',
    ...
    {
      question: 'What\'s the recommended rollout sequence for CodingAgent Audit Logs & Provenance?',
