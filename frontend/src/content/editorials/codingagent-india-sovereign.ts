...
export const codingagentIndiaSovereign: PillarEditorial = {
  ...
  updated: '2026-09-16',
  definition: 'India-first sovereign coding agent architecture tailored for national data autonomy, public sector compute, and Indian engineering enterprises.',
  sections: [
    {
      heading: 'What CodingAgent India Sovereign AI Actually Does',
      paragraphs: [
        'India-first sovereign coding agent architecture tailored for national data autonomy, public sector compute, and Indian engineering enterprises. Within CodingAgent.in\'s broader agentic engineering platform, this pillar is not a standalone feature toggle but a design constraint that shapes how the surrounding India & Solutions components are allowed to behave. Every capability described here is scoped by the same governance model the rest of the platform uses: an explicit boundary between what a model may reason about and what a tool is actually permitted to execute.',
        'Addresses growing demands for localized AI autonomy, eliminating vendor lock-in and foreign cloud dependence. That is the practical justification for treating this as its own architectural pillar rather than folding it into a more general capability: the failure modes it addresses are specific enough that a generic policy would either under-protect or over-restrict the surrounding workflow.',
      ],
      bullets: [
        'Tag: india-ai',
        'Tag: sovereign',
    ...
    },
    {
      ...
      paragraphs: [
        'Rather than taking any architectural description at face value -- including this one -- the more useful exercise for a team evaluating CodingAgent.in is to write down the specific failure scenario \'CodingAgent India Sovereign AI\' claims to prevent, and then check whether the platform\'s actual verification mechanism (described above) would catch that exact scenario if it happened. If it would not, that\'s a real gap worth raising, not a reason to distrust the pillar model in general -- the whole premise of naming these things explicitly is so gaps are locatable and fixable rather than hidden inside a vague, unauditable system prompt.',
        'The href for this page (`/india-sovereign-ai`) is a stable, canonical identifier once the pillar crosses the platform\'s own indexability bar -- so it\'s reasonable to bookmark or cite directly when tracking an evaluation decision back to the specific architectural claim that informed it.',
      ],
    },
  ],
  faq: [
    {
      question: 'What problem does CodingAgent India Sovereign AI actually solve?',
      answer: 'India-first sovereign coding agent architecture tailored for national data autonomy, public sector compute, and Indian engineering enterprises. Addresses growing demands for localized AI autonomy, eliminating vendor lock-in and foreign cloud dependence.',
    },
    {
      question: 'How is completion or correctness verified for this pillar?',
      answer: 'Self-hosted model verification and air-gapped test runners verified on Indian cloud and on-premise hardware.',
    },
    {
    ...
    },
    {
      ...
      answer: 'A misconfiguration in the \'CodingAgent India Sovereign AI\' area is designed to fail toward the more restrictive behavior rather than silently degrading to a more permissive one -- consistent with the platform\'s general ALLOW/ASK/DENY posture, an unclear or failed check defaults to requiring explicit human approval rather than proceeding automatically.',
    },
    {
      question: 'How does this pillar relate to CodingAgent DPDP Compliance, CodingAgent INR Pricing & Billing?',
      answer: 'It composes directly with CodingAgent DPDP Compliance, CodingAgent INR Pricing & Billing, CodingAgent Air-Gapped Agents, CodingAgent Private Deployment: none of these are meant to be adopted in isolation, and the platform\'s guarantees in this area assume the related pillars are also in place around it.',
    },
    {
    ...
    },
    {
      ...
      answer: 'It is categorized under India & Solutions, tagged india-ai, sovereign, bengaluru-tech, data-residency.',
    },
    {
      question: 'Who should read this page before adopting CodingAgent India Sovereign AI?',
    ...
    {
      question: 'What\'s the recommended rollout sequence for CodingAgent India Sovereign AI?',
