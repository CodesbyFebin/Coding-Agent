...
import { SURFACES, TERMINAL_MISSIONS } from '../../data/localRuntimesData';
import { EXECUTION_STAGES } from '../../data/architectureData';
...
export const PlatformPage = () => {
  ...
  useDocumentMeta(
    'Platform — Build Agents Like Production Systems | CodingAgent.in',
