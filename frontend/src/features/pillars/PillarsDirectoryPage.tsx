...
import { PILLAR_CATEGORIES, ALL_PILLARS } from '../../data/pillarsData';
...
export const PillarsDirectoryPage = () => {
  ...
  useDocumentMeta(
    ...
    'Complete index of all 80 CodingAgent.in architectural pillars: AI coding agents, MCP integrations, local LLMs, security & sovereignty, verification & memory, enterprise tooling, and India-first solutions.'
  );
