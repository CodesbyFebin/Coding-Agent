  ...
  return (
    <Box maxW="680px" mx="auto" pt={{ base: 4, md: 7 }}>
      ...
      >
        UNAVAILABLE
        <br />
        Browser automation is not simulated in the frontend.
        <br />
        A browser adapter must be configured and connected before any
        navigation, interaction, or screenshot capture is presented.
      </Box>
    </Box>
  );
};