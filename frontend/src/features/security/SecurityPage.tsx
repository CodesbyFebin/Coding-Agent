  ...
  return (
    <Box maxW="680px" mx="auto" pt={{ base: 4, md: 7 }}>
      ...
      >
        NOT_CONFIGURED
        <br />
        Security state is derived from the backend only.
        <br />
        Until a backend is connected, this view shows an empty state.
        <br />
        No security data (RLS policies, approval gates, truth
        boundaries) is available until the backend provides it.
      </Box>
    </Box>
  );
};