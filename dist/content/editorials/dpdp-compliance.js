    ...
    faq: [
        {
            ...
            answer: 'No certification is claimed. The platform provides DPDP-oriented controls — residency routing, minimal telemetry, PII hygiene, rights support, audit provenance — designed so your organisation can achieve and demonstrate compliance. Compliance is a legal determination specific to your deployment.'
        },
        {
            question: 'Who decides compliance for a deployment using this platform?',
            answer: 'Your organisation does, with its counsel and auditors. The platform produces the evidence, classifications, routing records, audit provenance, retention configuration, on which that determination rests, and deliberately avoids asserting a legal conclusion it cannot verify.'
        },
        {
            question: 'How does the platform handle consent records?',
            answer: 'Notice versions and consent artifacts are recorded with identity and timestamp in the audit store, so the organisation can answer what a principal agreed to and when, and prove withdrawal was honored.'
        },
        {
            question: 'What happens to audit records when a principal requests erasure?',
            answer: 'Operational personal data is erased per policy while the tamper-evident record of processing events is retained under the organisation\u2019s lawful basis, with deletions themselves recorded so the trail remains verifiable.'
        },
        {
            question: 'Do agent missions create shadow copies of personal data?',
            answer: 'The controls exist to prevent that: prompt and memory scrubbing, redaction where tasks do not require personal data, and retention matrices applied to mission memory so it never becomes an unmanaged store.'
        },
        {
            question: 'Is cross-border inference ever permitted for resident repositories?',
            answer: 'Only when policy explicitly allows it for the classification in force, and every grant or denial is recorded with its reason; the default posture for India-resident work is local or Indian-region endpoints only.'
        },
        {
            question: 'Is CodingAgent DPDP certified?',
            answer: 'No certification is claimed. The platform provides DPDP-oriented controls — residency routing, minimal telemetry, PII hygiene, rights support, audit provenance — designed so your organisation can achieve and demonstrate compliance. Compliance is a legal determination specific to your deployment.',
        },
        {
            ...
            answer: 'Under the default policy posture for India-resident repositories, inference routes to Indian-region or on-premise endpoints and cross-border egress is policy-blocked. The routing decision and its reason are recorded in the audit ledger so residency is verifiable per mission.',
        },
        {
            question: 'What personal data does the platform process?',
            answer: 'Developer identities for authentication and approvals, and any personal data embedded in repository content your missions touch. Telemetry is minimal by default and stays in your infrastructure; the data map is documented so your DPIA can be concrete.',
        },
        {
            question: 'How are data-principal requests handled?',
            answer: 'Identity records are exportable and erasable via the admin surface, and the audit store\u2019s addressing makes it possible to locate every processed artifact associated with a principal, subject to your retention policy.',
        },
    ],
    sources: [
        {
