    ...
    faq: [
        {
            ...
            answer: 'Because the model is probabilistic and context-biased: it tends to agree with itself, misses its own edge cases, and cannot objectively measure correctness. Independent systems — compilers, type checkers, test runners — share none of those failure modes and produce deterministic pass/fail evidence.',
        },
        {
            question: 'Which gates run for every mission?',
            answer: 'The mission configuration pins the gates before execution: typically build, typecheck, unit tests, and security scanning, plus any organization-specific custom gates. All applicable gates must pass; the conjunction is the completion criterion.',
        },
        {
            question: 'What happens when a gate fails?',
            answer: 'The failure evidence flows to the agent, which may attempt a repair. Repairs re-enter the full loop — the new workspace state is re-verified from scratch. If retries are exhausted, the mission escalates to human review with the complete evidence chain attached.',
        },
        {
            question: 'Can the agent change its acceptance criteria mid-mission?',
            answer: 'No. Gate commands are pinned in the mission configuration before execution. Changing criteria requires a new mission — otherwise the agent could weaken its own definition of done.',
        },
    ],
    sources: [
